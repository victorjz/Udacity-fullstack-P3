...
CLIENT_ID = json.loads(
    open('/var/www/catalog_app/catalog_app/client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/catalog_app/catalog_app/client_secrets.json', scope='')
...
def connect():
    ...
    DB = psycopg2.connect("dbname='catalog' user='catalog' host='localhost' password='CATaLOG'")
    dbcursor = DB.cursor()
    return DB, dbcursor
